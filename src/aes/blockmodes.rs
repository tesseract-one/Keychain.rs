...
use super::cryptoxide::buffer::{ReadBuffer, WriteBuffer, OwnedReadBuffer, OwnedWriteBuffer, BufferResult,
    RefReadBuffer, RefWriteBuffer};
use super::cryptoxide::buffer::BufferResult::{BufferUnderflow, BufferOverflow};
use super::cryptoutil::{self, symm_enc_or_dec};
use super::cryptoxide::symmetriccipher::{BlockEncryptor, BlockEncryptorX8, Encryptor, BlockDecryptor, Decryptor,
    SynchronousStreamCipher, SymmetricCipherError};
use super::cryptoxide::symmetriccipher::SymmetricCipherError::{InvalidPadding, InvalidLength};
...
mod test {
    ...
    use super::super::aessafe;
    use super::super::blockmodes::{EcbEncryptor, EcbDecryptor, CbcEncryptor, CbcDecryptor, CtrMode, CtrModeX8,
        NoPadding, PkcsPadding};
    use super::super::cryptoxide::buffer::{ReadBuffer, WriteBuffer, RefReadBuffer, RefWriteBuffer, BufferResult};
    use super::super::cryptoxide::buffer::BufferResult::{BufferUnderflow, BufferOverflow};
    use super::super::cryptoxide::symmetriccipher::{Encryptor, Decryptor};
    use super::super::cryptoxide::symmetriccipher::SymmetricCipherError::{self, InvalidLength, InvalidPadding};
