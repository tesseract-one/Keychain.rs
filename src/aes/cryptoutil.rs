...
use super::cryptoxide::buffer::{ReadBuffer, WriteBuffer, BufferResult};
use super::cryptoxide::buffer::BufferResult::{BufferUnderflow, BufferOverflow};
use super::cryptoxide::symmetriccipher::{SynchronousStreamCipher, SymmetricCipherError};
...
pub mod test {
    ...
    use super::super::cryptoutil::{add_bytes_to_bits, add_bytes_to_bits_tuple};
    use super::super::cryptoxide::digest::Digest;
